...
//   atr_past = iATR(NULL, 0, atr_period, atr_shift);      // ATR(20) 10 periods ago
      ...
      if(OrderType() <= OP_SELL &&  OrderSymbol() == Symbol() && OrderMagicNumber() == MagicNumber) {
         ...
         if(OrderType() == OP_BUY) {
            ...
            */
            ...
            if( eis_down == 1 || eis_neutral == 1 || //macd_prev1 < macd_prev2 ||
            ...
            */
            ...
            if ( eis_up == 1 || eis_neutral == 1 || //macd_prev1 > macd_prev2 ||
                     (DayOfWeek() == 5 && Hour() == 23 && Minute() >= 45 ) ) 
   ...
   */
   ...
   {
      rsi = iRSI(NULL, 0, rsi_ind_val, PRICE_CLOSE, 1); 
